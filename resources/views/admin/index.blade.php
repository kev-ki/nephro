            ...
            <table class="table">
                ...
                @foreach($user as $users)
                    <tr>
                        ...
                        <td class="row">
                            <div class="mr-1">
                                <a href="{{route('admin.edit', $users->id)}}" class="btn-sm btn-primary mb-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
