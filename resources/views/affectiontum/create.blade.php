...
@section('content')
    ...
    <div class="container-fluid p-2" style="background-color: white">
        ...
        <div class="card p-2">
            <div class="card-header text-center font-weight-bold text-uppercase">AFFECTIONS TUMORALES MALIGNES</div>
            <div class="card-body">
                <form action="{{route('affectionTumorale.store')}}" method="post">
                    @csrf
                    <div class="col">
                        <div class="form-group row">
                            <label class="font-weight-bold col-md-2 text-right">Type<em style="color: red;">*</em> :</label>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="btn btn-secondary"><a style="color: white" href="{{route('Autre_antecedent_medical.create')}}">Suivant</a></div>
                    </div>
                </form>
            </div>
        </div>
