               ...
               <div class="">
                   <div class="col">
                       <div class="form-group row">
                           <label for="patientid" class="col-md-2 col-form-label text-right font-weight-bold">ID Patient :</label>
                   ...
                   <div class="col">
                       <div class="form-group row">
                           ...
                           <label for="statuts" class="col-md-2 col-form-label text-right font-weight-bold">Statuts :</label>
