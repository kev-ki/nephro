                    ...
                    <table class="table">
                        ...
                        @foreach($patient as $pa)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('medecin.show',$pa->idpatient)}}" class="btn-sm mr-1 btn-primary">
                                    ...
                                    <a href="{{route('medecin.edit',$pa->idpatient)}}" class="btn-sm btn-secondary">
                                ...
                                <td><a href="{{route('consultation.begin', $pa->idpatient)}}" class="btn-sm btn-outline-primary">examiner</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
