...
@section('content')
    <h1 class="text-center" style="background-color: #01A9CB; height: 30px; font-size: large; padding-top: 5px; font-weight: bold">Annuaire Archive Hospitalisations</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <form method="POST" class="col-md-7" action="{{route('infirmier.archive_search')}}">
                                @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($patients_hospi as $hospi)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('hospitalisation.show',$hospi->id)}}" class="btn-sm mr-1 btn-primary">
