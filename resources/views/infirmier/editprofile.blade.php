...
@section('content')
    <h1 class="text-center" style="background-color: #01A9CB; height: 30px; font-weight: bold; font-size: large; padding-top: 5px;">édition du profile</h1>
    <div class="container-fluid p-2" style="background-color: white">
        ...
        <div class="p-2">
            <form method="post" action="{{route('infirmier.updateprofile', $user->id)}}" accept-charset="utf-8">
                @method('put')
                @csrf
                <div class="col">
