                        ...
                        <div class="row">
                            <div class="col-md-5 d-flex justify-content-start">
                                <button class="btn btn-outline-primary mr-1 mb-sm-1-1">
                                    <a href="{{route('infirmier.create')}}">Nouveau patient
                            ...
                            <form method="POST" class="col-md-7" action="{{route('infirmier.search')}}">
                                @csrf
                                <div class="col-md d-flex justify-content-end">
                                    <select id="option" type="text" class="col-md-2 selectpicker form-control @error('option') is-invalid @enderror" name="option" data-placeholder="Choisir" data-style="btn-outline-secondary">
                                        ...
                                        <option value="burkina">Tel Burkina</option>
                                    </select>
                                    @error('option')
                        ...
                        <table class="table">
                            ...
                            @foreach($patient as $pa)
                                <tr>
                                    ...
                                    <td>+226 {{$pa->telephone1}}</td>
                                    <td>{{ $pa->created_at }}</td>

                                    <td>
                                        <a href="{{route('infirmier.show',$pa->idpatient)}}" class="btn-sm mr-1 btn-primary">
