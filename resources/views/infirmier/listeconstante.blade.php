    ...
    <div class="container-fluid p-2" style="background-color: white">
        <div class="card p-1">
            <div class="card-header">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" action="{{route('constante-inf.search')}}">
                            @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($constantes as $constante)
                                <tr>
                                    ...
                                    <td><a href="{{route('infirmier.constante',$constante->id)}}" class="btn-sm mr-1 btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
