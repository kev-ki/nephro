...
@section('content')
    <h1 class="text-center" style="background-color: #01A9CB; height: 30px; font-size: large; padding-top: 5px; font-weight: bold">Enregistrement du patient</h1>
   <div class="container-fluid p-2" style="background-color: white">
       ...
       <div class="card">
           ...
           <div class="card-body">
               <form action="{{ route('medecin.store') }}" method="POST" class="table-responsive-sm">
                   @csrf
