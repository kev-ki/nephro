                        ...
                        <table class="table">
                            ...
                            @foreach($constantes as $constante)
                                <tr>
                                    ...
                                    <td><a href="{{route('medecin.constante',$constante->id)}}" class="btn-sm mr-1 btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
