...
@section('content')
    ...
    <div class="container-fluid p-1" style="background-color: white">
        ...
        <div class="card bg-white">
            ...
            <p><a href="{{route('medecin.index')}}"><<<< Annuaire des patients</a></p>
            ...
            <div class="col">
                <div class="row d-flex justify-content-center mb-2">
                    <button class="btn btn-outline-secondary mr-1"><a style="color: #444" href="{{route('medecin.edit', $patient->idpatient)}}">éditer le dossier</a></button>

                    <button class="btn btn-outline-primary mr-1"><a style="color: #444" href="{{route('medecin.constanteindex', $patient->idpatient)}}">voir constantes</a></button>

                    <button class="btn btn-outline-primary mr-1"><a style="color: #444" href="{{route('medecin.consultationindex', $patient->idpatient)}}">consultations précédentes</a></button>
