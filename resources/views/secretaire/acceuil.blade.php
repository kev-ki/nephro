                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <form method="POST" class="col-md-7" action="{{route('secret.search')}}">
                                @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($patient as $pa)
                                <tr>
                                    ...
                                    <td><a href="{{route('secret.show',$pa->idpatient)}}" class="btn-sm mr-1 btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
