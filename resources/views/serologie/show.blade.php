                    ...
                    <div class="tab-pane fade" role="tabpanel" aria-labelledby="page2_tab" id="page2">
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <input type="text" readonly name="serologiedengue" class="form-control col-md-10" value="{{$serologie->serologie_dengue}}">
                            </div>
                        </div>
                        ...
                        @if($serologie->nom_autre || $serologie->nom_autre1)
                            <div class="col" align="center">
                                <div class="form-group row font-weight-bold" style="font-size: 17px">
                                    ...
                                    <input type="checkbox" disabled readonly checked onclick="fonctionParaclinic(this)" class="custom-checkbox col-md-1">Autre sérologie  <em class="font-italic font-weight-normal" style="font-size: small">&nbsp; ** optionnel **</em>
                                </div>
                            </div>
                            ...
                            <div class="col" id="autre_para" style="display: block">
                                @if($serologie->nom_autre)
                                    <div class="form-group row">
                                        ...
                                        <input type="text" readonly value="{{$serologie->nom_autre}}" name="nom_autre" class="form-control col-md-5" >
                                        <input type="text" readonly value="{{$serologie->resultat}}" name="resultat" class="form-control col-md-5" >
                                    </div>
                                @else
                                ...
                                @if($serologie->nom_autre1)
                                    <div class="form-group row">
                                        <div class="offset-md-2"></div>
                                        <input type="text" readonly value="{{$serologie->nom_autre1}}" name="nom_autre1" class="form-control col-md-5">
                                        <input type="text" readonly value="{{$serologie->resultat1}}" name="resultat1"  class="form-control col-md-5">
                                    </div>
                                @else
                                    <div class="form-group row" style="display: none">
                                        <div class="offset-md-2"></div>
                        ...
                        @else
                            <div class="col" align="center" style="display: none">
                                <div class="form-group row font-weight-bold" style="font-size: 17px">
                                    <div class="offset-5"></div>
                                    <input type="checkbox" readonly onclick="fonctionParaclinic(this)" class="custom-checkbox col-md-1">Autre Sérologie  <em class="font-italic font-weight-normal" style="font-size: small">&nbsp; ** optionnel **</em>
                                </div>
                            </div>
