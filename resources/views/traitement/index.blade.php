...
@section('content')
    <h1 class="text-center" style="background-color: #01A9CB; height: 30px; font-size: large; padding-top: 5px; font-weight: bold">Traitements de la consultation du {{$consult->created_at}}</h1>
                    ...
                    <table class="table">
                        ...
                        @foreach($donnees as $donnees)
                            <tr>
                                ...
                                <td>{{$donnees->date}}</td>
                                <td>{{$donnees->prescription}}</td>
                                <td>{{$donnees->posologie}}</td>
                                ...
                                <td>
                                    <a href="{{route('traitement.show',$donnees->id)}}" class="btn-sm mr-1 btn-secondary">
